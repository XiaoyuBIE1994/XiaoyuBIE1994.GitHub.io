...
precision 代表了预测为positive的样本中有多少是真的为positive，recall 代表了所有的 positive 样本有多少被正确的预测出来了。通常在进行分类判断时，阈值设置的越严格，precision 越高，recall 越低，阈值设置的越宽松，precision 越低，recall 越高。
